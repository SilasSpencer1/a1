  ...
  return (
    <div id="wd-lab1">
      ...
      <ul>
        ...
        <li><Link href="/labs/lab2/tailwind">Lab 2: Tailwind CSS</Link></li>
      ...
      <ul>
        ...
        <li>
          <a href="https://github.com/SilasSpencer1/a1" id="wd-github">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>Season chicken breast with salt, pepper, and garlic powder.</li>
          <li>Heat olive oil in an oven-safe skillet over medium-high heat.</li>
          <li>Sear chicken for 3 minutes per side until golden brown.</li>
          <li>Transfer skillet to oven and bake for 15-20 minutes.</li>
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <br />
          <textarea id="wd-textarea" cols={30} rows={10} defaultValue="Lorem ipsum dolor sit amet, consectetur adipiscing elit." />
